...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	public Pong()
	{
		...
		ball = new Ball(400, 200, 10, 10, Color.black);
		leftPaddle = new Paddle(50, 200, 20, 40, 5);
		rightPaddle = new Paddle(700, 200, 20, 40, 5);
   ...
   public void paint(Graphics window)
   {
	   ...
	   if(!(ball.getY() >= 10 && ball.getY() <= 450)) ball.setYSpeed(-ball.getYSpeed());
